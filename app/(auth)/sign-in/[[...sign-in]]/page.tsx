        ...
        <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
          ...
          <div className="hidden lg:relative lg:block lg:p-12">
            ...
            <p className="mt-4 leading-relaxed text-black/90">
              Feel free to log in and generate custom learning paths for your
              students—effortless and personalized education at your fingertips!
            </p>
          </div>
        </section>
        ...
        <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
          <div className="max-w-xl lg:max-w-3xl">
            <div className="relative -mt-16 block lg:hidden">
              ...
              Feel free to log in and generate custom learning paths for your students—effortless and personalized education at your fingertips!
              </p>
            </div>
            <SignIn />
          </div>
