      ...
      <main className="flex-1 ml-0 md:ml-64 overflow-y-auto h-screen">
        {selectedChapter ? (
          ...
          <div className="p-10 flex flex-col items-center justify-center text-center">
            <Image
              src={course.courseBanner || "/FuturEd-logo.png"}
              alt={course.courseName || "FuturEd"}
              width={350}
              height={200}
              priority
            ...
            <div className="mt-10">
              <UserToolTip
                username={course.username || "FuturEd"}
                userProfileImage={course.userprofileimage || "/futuredlogo.png"}
              />
            </div>
          </div>
        )}
